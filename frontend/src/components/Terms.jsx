...
export default function Terms() {
  return (
    <div className="fade-in slide-up" style={{maxWidth: '900px', margin: '60px auto'}}>
      <div className="sub-label" style={{color: 'var(--accent-blue)', fontSize: '13px', marginBottom: '8px'}}>Governance Layer</div>
      <h1 className="big-title" style={{fontSize: '56px', marginBottom: '32px'}}>Terms of<br/><span className="green-text">Sovereign Engagement.</span></h1>
      
      <div className="card-light" style={{padding: '56px', borderRadius: 'var(--radius-xl)'}}>
        <div style={{display: 'flex', flexDirection: 'column', gap: '40px'}}>
          <section>
            <h2 className="sub-label" style={{fontSize: '14px', marginBottom: '16px', color: 'var(--bg-navy)'}}>01. Sovereign Data Ownership</h2>
          ...
          <section>
            <h2 className="sub-label" style={{fontSize: '14px', marginBottom: '16px', color: 'var(--bg-navy)'}}>02. Intelligence Accuracy</h2>
            <p style={{fontSize: '16px', color: 'var(--text-secondary)', lineHeight: 1.7}}>
          ...
          <section>
            <h2 className="sub-label" style={{fontSize: '14px', marginBottom: '16px', color: 'var(--bg-navy)'}}>03. Prohibited Usage</h2>
            <p style={{fontSize: '16px', color: 'var(--text-secondary)', lineHeight: 1.7}}>
          ...
          <section>
            <h2 className="sub-label" style={{fontSize: '14px', marginBottom: '16px', color: 'var(--bg-navy)'}}>04. Service Availability</h2>
            <p style={{fontSize: '16px', color: 'var(--text-secondary)', lineHeight: 1.7}}>
        ...
        <div className="card-blue" style={{marginTop: '48px', padding: '32px', textAlign: 'center'}}>
